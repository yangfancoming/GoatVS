    ...
    public class Linq1 {
        ...
        public static void test1() {
            var result =
                ...
                // 返回结果
                select n;
            result.ForEach(x => Debug.Print(x));
        }
        ...
        */
        public static void test33() {
            ...
            result.ForEach(x => Debug.Print(x.ToString()));
        }
        ...
        public static void test4() {
            ...
            result1.ForEach(x => Debug.Print(x.ToString()));
            // 排序后输出结果： 4 5 6
            var result2 = BaseData.nums.Where(n => n>3 ).OrderBy(n=>n);
            result2.ForEach(x => Debug.Print(x.ToString()));
        }
        ...
        public static void test5() {
            ...
            result.ForEach(x => Debug.Print(x.ToString()));
            Debug.Print("记录数" + result.Count());
            Debug.Print("最大值" + result.Max());
            Debug.Print("最小值" + result.Min());
            Debug.Print("平均数" + result.Average());
            Debug.Print("求和" + result.Sum());
        }
        ...
        */
        ...
        public static void test8() {
            ...
            result2.ForEach(x => Debug.Print(x));
        }
        ...
        public static void test9() {
            ...
            if (result) {
                Debug.Print("Some customers are in the USA");
            }
            else {
                Debug.Print("No customers are in the USA");
            }
        }
        ...
        public static void test10() {
            ...
            if (allAsia) {
                Debug.Print("All customers are in Asia");
            }
            else {
                Debug.Print("Not all customers are in Asia");
            }
        }
    }
}